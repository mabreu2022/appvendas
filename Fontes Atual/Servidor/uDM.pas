...
type
  TDM = class(TDataModule)
    ...
    qryAdmEmpresa: TFDQuery;
    qryAdmEmpresaCODEMP: TIntegerField;
    qryAdmEmpresaNOME: TStringField;
    qryAdmEmpresaNOMEFANTASIA: TStringField;
    qryAdmEmpresaENDERTPLOGRAD: TStringField;
    qryAdmEmpresaENDERLOGRAD: TStringField;
    qryAdmEmpresaENDERNUMLOGRAD: TStringField;
    qryAdmEmpresaENDERCOMPLEMENTO: TStringField;
    qryAdmEmpresaENDERBAIRRO: TStringField;
    qryAdmEmpresaCODCIDADE: TIntegerField;
    qryAdmEmpresaNUMTELEFONE: TStringField;
    qryAdmEmpresaUSUARIO: TIntegerField;
    qryAdmEmpresaDATAATU: TDateField;
    qryAdmEmpresaHORAATU: TStringField;
    qryAdmEmpresaINEXPORTADOR: TStringField;
    qryAdmEmpresaDOCFISCAL: TStringField;
    qryAdmEmpresaDOCFISCALREPRLEGAL: TStringField;
    qryAdmEmpresaNOMEREPRLEGAL: TStringField;
    qryAdmEmpresaTPREPRLEGAL: TStringField;
    qryAdmEmpresaNACIONALIDADE: TStringField;
    qryAdmEmpresaESTADOCIVIL: TStringField;
    qryAdmEmpresaDOCIDENTIDADE: TStringField;
    qryPedidosFBCODEMP: TIntegerField;

...
begin
  ...
  dmBanco.qryReceber.SQL.Add('select * from TB_RECEBER order by DATA_VENCTO');
  dmBanco.qryReceber.Open;*)

  (*frmTabs.ListViewReceber.BeginUpdate;
  dmBanco.qryReceber.First;
  frmTabs.ListViewReceber.Items.Clear;
  while not dmBanco.qryReceber.Eof do
  begin
    with frmTabs.ListViewReceber.Items.Add do
    begin
  ...
  frmTabs.ListViewReceber.EndUpdate;*)
  //frmTabs.image5.Visible := false;
  //frmTabs.image12.Visible:= false;

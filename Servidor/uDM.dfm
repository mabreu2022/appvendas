object DM: TDM
  ...
  object ConexaoFB: TFDConnection
    Params.Strings = (
      'User_Name=sysdba'
      'Password=key2624'
      'Database=C:\FVENDAS\Bin\Dados\FB_DADOS.FDB'
  ...
  object ConexaoCli: TFDConnection
    Params.Strings = (
      'Database=C:\SYSTEM\SGLOJA\DADOS\FB_DADOS.FDB'
      'User_Name=sysdba'
      'Password=key2624'
      'CharacterSet=WIN1252'
      'DriverID=FB')
  ...
  object qryProdutosCli: TFDQuery
    ...
    Left = 320
    Top = 128
    object qryProdutosCliCODEMP: TIntegerField
      FieldName = 'CODEMP'
      Origin = 'CODEMP'
    end
    ...
    object qryProdutosCliDTULTALT: TDateField
      FieldName = 'DTULTALT'
      Origin = 'DTULTALT'
    end
  ...
  object qryProdutosFB: TFDQuery
    ...
    Left = 32
    Top = 128
    object qryProdutosFBCODEMP: TIntegerField
      FieldName = 'CODEMP'
      Origin = 'CODEMP'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object qryProdutosFBSALDO: TFMTBCDField
      FieldName = 'SALDO'
      Origin = 'SALDO'
      Precision = 18
      Size = 3
    end
    object qryProdutosFBDAT_ALTERADO: TSQLTimeStampField
      FieldName = 'DAT_ALTERADO'
      Origin = 'DAT_ALTERADO'
      Required = True
    end
    object qryProdutosFBCODMOEDA: TIntegerField
      FieldName = 'CODMOEDA'
      Origin = 'CODMOEDA'
    end
  end
  ...
  object qryAdmEmpresasFB: TFDQuery
    Connection = ConexaoFB
    SQL.Strings = (
      'select * from ADM_EMPRESA')
    Left = 214
    Top = 79
    object qryAdmEmpresasFBCODEMP: TIntegerField
      FieldName = 'CODEMP'
      Origin = 'CODEMP'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryAdmEmpresasFBNOME: TStringField
      FieldName = 'NOME'
      Origin = 'NOME'
      Size = 40
    end
    object qryAdmEmpresasFBNOMEFANTASIA: TStringField
      FieldName = 'NOMEFANTASIA'
      Origin = 'NOMEFANTASIA'
      Size = 60
    end
    object qryAdmEmpresasFBENDERTPLOGRAD: TStringField
      FieldName = 'ENDERTPLOGRAD'
      Origin = 'ENDERTPLOGRAD'
      Size = 10
    end
    object qryAdmEmpresasFBENDERLOGRAD: TStringField
      FieldName = 'ENDERLOGRAD'
      Origin = 'ENDERLOGRAD'
      Size = 100
    end
    object qryAdmEmpresasFBENDERNUMLOGRAD: TStringField
      FieldName = 'ENDERNUMLOGRAD'
      Origin = 'ENDERNUMLOGRAD'
      Size = 10
    end
    object qryAdmEmpresasFBENDERCOMPLEMENTO: TStringField
      FieldName = 'ENDERCOMPLEMENTO'
      Origin = 'ENDERCOMPLEMENTO'
      Size = 15
    end
    object qryAdmEmpresasFBENDERBAIRRO: TStringField
      FieldName = 'ENDERBAIRRO'
      Origin = 'ENDERBAIRRO'
      Size = 30
    end
    object qryAdmEmpresasFBCODCIDADE: TIntegerField
      FieldName = 'CODCIDADE'
      Origin = 'CODCIDADE'
    end
    object qryAdmEmpresasFBNUMTELEFONE: TStringField
      FieldName = 'NUMTELEFONE'
      Origin = 'NUMTELEFONE'
    end
    object qryAdmEmpresasFBUSUARIO: TIntegerField
      FieldName = 'USUARIO'
      Origin = 'USUARIO'
      Required = True
    end
    object qryAdmEmpresasFBDATAATU: TDateField
      FieldName = 'DATAATU'
      Origin = 'DATAATU'
      Required = True
    end
    object qryAdmEmpresasFBHORAATU: TStringField
      FieldName = 'HORAATU'
      Origin = 'HORAATU'
      Required = True
      Size = 8
    end
    object qryAdmEmpresasFBINEXPORTADOR: TStringField
      FieldName = 'INEXPORTADOR'
      Origin = 'INEXPORTADOR'
      Size = 4
    end
    object qryAdmEmpresasFBDOCFISCAL: TStringField
      FieldName = 'DOCFISCAL'
      Origin = 'DOCFISCAL'
      Size = 25
    end
    object qryAdmEmpresasFBDOCFISCALREPRLEGAL: TStringField
      FieldName = 'DOCFISCALREPRLEGAL'
      Origin = 'DOCFISCALREPRLEGAL'
      Size = 25
    end
    object qryAdmEmpresasFBNOMEREPRLEGAL: TStringField
      FieldName = 'NOMEREPRLEGAL'
      Origin = 'NOMEREPRLEGAL'
      Size = 40
    end
    object qryAdmEmpresasFBTPREPRLEGAL: TStringField
      FieldName = 'TPREPRLEGAL'
      Origin = 'TPREPRLEGAL'
      Size = 1
    end
    object qryAdmEmpresasFBNACIONALIDADE: TStringField
      FieldName = 'NACIONALIDADE'
      Origin = 'NACIONALIDADE'
    end
    object qryAdmEmpresasFBESTADOCIVIL: TStringField
      FieldName = 'ESTADOCIVIL'
      Origin = 'ESTADOCIVIL'
    end
    object qryAdmEmpresasFBDOCIDENTIDADE: TStringField
      FieldName = 'DOCIDENTIDADE'
      Origin = 'DOCIDENTIDADE'
    end
  end
  object qryAdmEmpresasCli: TFDQuery
    Connection = ConexaoCli
    SQL.Strings = (
      'select * from V_ADM_EMPRESA')
    Left = 320
    Top = 79
    object qryAdmEmpresasCliCODEMP: TIntegerField
      FieldName = 'CODEMP'
      Origin = 'CODEMP'
    end
    object qryAdmEmpresasCliNOME: TStringField
      FieldName = 'NOME'
      Origin = 'NOME'
      Size = 40
    end
    object qryAdmEmpresasCliNOMEFANTASIA: TStringField
      FieldName = 'NOMEFANTASIA'
      Origin = 'NOMEFANTASIA'
      Size = 60
    end
    object qryAdmEmpresasCliENDERTPLOGRAD: TStringField
      FieldName = 'ENDERTPLOGRAD'
      Origin = 'ENDERTPLOGRAD'
      Size = 10
    end
    object qryAdmEmpresasCliENDERLOGRAD: TStringField
      FieldName = 'ENDERLOGRAD'
      Origin = 'ENDERLOGRAD'
      Size = 100
    end
    object qryAdmEmpresasCliENDERNUMLOGRAD: TStringField
      FieldName = 'ENDERNUMLOGRAD'
      Origin = 'ENDERNUMLOGRAD'
      Size = 10
    end
    object qryAdmEmpresasCliENDERCOMPLEMENTO: TStringField
      FieldName = 'ENDERCOMPLEMENTO'
      Origin = 'ENDERCOMPLEMENTO'
      Size = 15
    end
    object qryAdmEmpresasCliENDERBAIRRO: TStringField
      FieldName = 'ENDERBAIRRO'
      Origin = 'ENDERBAIRRO'
      Size = 30
    end
    object qryAdmEmpresasCliCODCIDADE: TIntegerField
      FieldName = 'CODCIDADE'
      Origin = 'CODCIDADE'
    end
    object qryAdmEmpresasCliCODCIDADEPY: TIntegerField
      FieldName = 'CODCIDADEPY'
      Origin = 'CODCIDADEPY'
    end
    object qryAdmEmpresasCliNUMTELEFONE: TStringField
      FieldName = 'NUMTELEFONE'
      Origin = 'NUMTELEFONE'
    end
    object qryAdmEmpresasCliUSUARIO: TIntegerField
      FieldName = 'USUARIO'
      Origin = 'USUARIO'
    end
    object qryAdmEmpresasCliDATAATU: TDateField
      FieldName = 'DATAATU'
      Origin = 'DATAATU'
    end
    object qryAdmEmpresasCliHORAATU: TStringField
      FieldName = 'HORAATU'
      Origin = 'HORAATU'
      Size = 8
    end
    object qryAdmEmpresasCliINEXPORTADOR: TStringField
      FieldName = 'INEXPORTADOR'
      Origin = 'INEXPORTADOR'
      Size = 4
    end
    object qryAdmEmpresasCliDOCFISCAL: TStringField
      FieldName = 'DOCFISCAL'
      Origin = 'DOCFISCAL'
      Size = 25
    end
    object qryAdmEmpresasCliDOCFISCALREPRLEGAL: TStringField
      FieldName = 'DOCFISCALREPRLEGAL'
      Origin = 'DOCFISCALREPRLEGAL'
      Size = 25
    end
    object qryAdmEmpresasCliNOMEREPRLEGAL: TStringField
      FieldName = 'NOMEREPRLEGAL'
      Origin = 'NOMEREPRLEGAL'
      Size = 40
    end
    object qryAdmEmpresasCliTPREPRLEGAL: TStringField
      FieldName = 'TPREPRLEGAL'
      Origin = 'TPREPRLEGAL'
      Size = 1
    end
    object qryAdmEmpresasCliNACIONALIDADE: TStringField
      FieldName = 'NACIONALIDADE'
      Origin = 'NACIONALIDADE'
    end
    object qryAdmEmpresasCliESTADOCIVIL: TStringField
      FieldName = 'ESTADOCIVIL'
      Origin = 'ESTADOCIVIL'
    end
    object qryAdmEmpresasCliDSEMAIL: TStringField
      FieldName = 'DSEMAIL'
      Origin = 'DSEMAIL'
      Size = 150
    end
    object qryAdmEmpresasCliDSSENHAEMAIL: TStringField
      FieldName = 'DSSENHAEMAIL'
      Origin = 'DSSENHAEMAIL'
      Size = 50
    end
    object qryAdmEmpresasCliDOCIDENTIDADE: TStringField
      FieldName = 'DOCIDENTIDADE'
      Origin = 'DOCIDENTIDADE'
    end
    object qryAdmEmpresasCliNOMECIDADE: TStringField
      FieldName = 'NOMECIDADE'
      Origin = 'NOMECIDADE'
      Size = 60
    end
    object qryAdmEmpresasCliCODPAIS: TStringField
      FieldName = 'CODPAIS'
      Origin = 'CODPAIS'
      Size = 3
    end
    object qryAdmEmpresasCliCODUF: TStringField
      FieldName = 'CODUF'
      Origin = 'CODUF'
      Size = 2
    end
    object qryAdmEmpresasCliCEP: TStringField
      FieldName = 'CEP'
      Origin = 'CEP'
      Size = 10
    end
    object qryAdmEmpresasCliCIDADEEMP: TStringField
      FieldName = 'CIDADEEMP'
      Origin = 'CIDADEEMP'
      Size = 60
    end
    object qryAdmEmpresasCliCIDADEEMP1: TStringField
      FieldName = 'CIDADEEMP1'
      Origin = 'CIDADEEMP1'
      Size = 66
    end
    object qryAdmEmpresasCliPAISCLI: TStringField
      FieldName = 'PAISCLI'
      Origin = 'PAISCLI'
      Size = 4
    end
    object qryAdmEmpresasCliCODDISTRITO: TIntegerField
      FieldName = 'CODDISTRITO'
      Origin = 'CODDISTRITO'
    end
    object qryAdmEmpresasCliNOMEDISTRITO: TStringField
      FieldName = 'NOMEDISTRITO'
      Origin = 'NOMEDISTRITO'
      Size = 60
    end
    object qryAdmEmpresasCliCODDEPARTAMENTO: TStringField
      FieldName = 'CODDEPARTAMENTO'
      Origin = 'CODDEPARTAMENTO'
      Size = 2
    end
    object qryAdmEmpresasCliNOMEDEPARTAMENTO: TStringField
      FieldName = 'NOMEDEPARTAMENTO'
      Origin = 'NOMEDEPARTAMENTO'
      Size = 60
    end
    object qryAdmEmpresasCliCHAVEELETRONICA: TStringField
      FieldName = 'CHAVEELETRONICA'
      Origin = 'CHAVEELETRONICA'
      Size = 100
    end
    object qryAdmEmpresasCliDSAPIDE: TStringField
      FieldName = 'DSAPIDE'
      Origin = 'DSAPIDE'
      Size = 50
    end
    object qryAdmEmpresasCliTIPOCOMERCIO: TIntegerField
      FieldName = 'TIPOCOMERCIO'
      Origin = 'TIPOCOMERCIO'
    end
  end
end
